...
from LLVMEnv.SearchMethods.GA import LeverageSyner_GA
...
def calculate_overoz_for_file(filename, cluster_label, edges_dict, cluster_pass_sequences, base_path, llvm_tools_path):
    ...
    min_instr_count = LeverageSyner_GA(edges, ll_code, pass_sequences, llvm_tools_path)
...
output_file_path = os.path.join(project_root, 'output', 'Phase4_geannvp_GAResult.csv')
